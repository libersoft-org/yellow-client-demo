<div class="comments">
    ...
    <div class="comment-showall">show all comments</div>
</div>
...
<style>
    ...
    .like-dislike, .element-l, .element-p {
        display: flex;
        padding:4px;
        height:28px;
        align-items: center;
    ...
    .imgdiv-like, .imgdiv-dislike  {
        width: 20px;
        height:20px;
        margin-right: 4px;
    }
    .element-l:hover, .element-p:hover  {
        border-radius:4px;
    ...
    .imgdiv-like img, .imgdiv-dislike img {
        width:100%;
        height:100%;
    }
    .comment-showall {
